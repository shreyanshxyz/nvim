	...
	},
	{
		...
		config = function()
			...
			for _, mode in ipairs(modes) do
				if theme[mode] then
					for section, conf in pairs(theme[mode]) do
						if conf.bg then
...
vim.keymap.set(
	...
	"<leader>dd",
	"<cmd>CodeDiff<CR>",
	{ noremap = true, silent = true, desc = "Open git diff explorer" }
)
vim.keymap.set(
	"n",
	"<leader>df",
	"<cmd>CodeDiff file HEAD<CR>",
	{ noremap = true, silent = true, desc = "Diff current file vs HEAD" }
)
vim.keymap.set(
	"n",
	"<leader>dh",
	"<cmd>CodeDiff history<CR>",
	{ noremap = true, silent = true, desc = "Open file history" }
)
vim.keymap.set(
	"n",
	"<leader>dm",
	"<cmd>CodeDiff merge<CR>",
	{ noremap = true, silent = true, desc = "Open merge conflict view" }
)

vim.keymap.set("n", "<leader>cc", function()
	require("git-commit").ai_commit()
end, { desc = "AI commit (Ollama)" })
